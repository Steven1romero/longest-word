...
set -gx VIRTUAL_ENV /home/jsteven.romeror/code/Steven1romero/longest-word/.venv
...
if test -n longest-word-py3.12
    set -gx VIRTUAL_ENV_PROMPT longest-word-py3.12
else
